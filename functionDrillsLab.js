...
var nameGreeting = nameCheck('Heet')
...
var newContestants = theEliminator(contestants, loser)
...
/*
  ...
  in entirely uppercase characters. Invoke the function, passing in the sampleString (above).
*/

//CODE HERE

function stringUppercase(newString){
  upperCase = newString.toUpperCase()
  console.log(upperCase)
}
stringUppercase(sampleString)
...
/*
  ...
  you were able to purchase. Create a variable called `totalFrogs` and set it equal to your function invoked, passing 
  in the amount of gold you are willing to spend.
*/

//CODE HERE

function chocolateFrog (amountGold){
  return amountGold / 3
}
let totalChocolates = chocolateFrog(4)
...
function chocolateFrog2 (amountGold){
  if (amountGold % 3 === 0){
    return amountGold / 3
  } else if ((amountGold - 1) % 3 === 0) {
    return (amountGold - 1) / 3
  } else {
    return (amountGold - 2) / 3
  }

}
let totalChocolates2 = chocolateFrog2(4)
console.log(totalChocolates2)
